			...
			<div className="flex justify-between items-end">
				<div>
					...
					<p className="text-white/50 mt-2 text-sm max-w-md">
						The game is played on a closed loop of 26 nodes. Hover
						over the nodes to analyze their strategic value.
					</p>
				</div>
					...
					className={`cursor-target w-64 p-4 rounded-xl border backdrop-blur-md transition-all duration-300 ${
						hoveredNode
							? hoveredNode.type === "POWER"
								...
								: hoveredNode.type === "HOME_P1"
									? "bg-emerald-500/10 border-emerald-500/50"
									: hoveredNode.type === "HOME_P2"
					...
					<div className="grid grid-cols-2 gap-2 text-xs">
						<div className="bg-black/30 p-2 rounded">
							...
							<div className="font-mono font-bold text-white">
								{hoveredNode
									? hoveredNode.type.includes("HOME") ||
										hoveredNode.type === "POWER"
										? "+5"
										: "+1"
									: "--"}
