        ...
        <div className="space-y-8 h-full flex flex-col justify-center items-center text-center">
            ...
            <div className="space-y-4 max-w-lg">
                ...
                <p className="text-white/50">
                    Initialize the local training environment to test your strategy against dummy bots before submitting to the main leaderboard.
                </p>
                
                <button className="bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-3 rounded text-sm font-bold uppercase tracking-widest transition-all shadow-lg hover:shadow-emerald-500/25 active:scale-95">
                    Launch Simulator
                </button>
            </div>
             ...
             <div className="grid grid-cols-3 gap-4 w-full max-w-2xl mt-8">
                <div className="bg-white/5 p-4 rounded border border-white/10 flex flex-col items-center gap-2">
                    ...
                    <div className="text-[10px] text-white/40 uppercase tracking-widest">Wins</div>
                </div>
                <div className="bg-white/5 p-4 rounded border border-white/10 flex flex-col items-center gap-2">
                    <div className="text-white font-mono text-xl">8</div>
                    <div className="text-[10px] text-white/40 uppercase tracking-widest">Games Played</div>
                </div>
                <div className="bg-white/5 p-4 rounded border border-white/10 flex flex-col items-center gap-2">
                    <div className="text-red-500 font-mono text-xl">12%</div>
                    <div className="text-[10px] text-white/40 uppercase tracking-widest">Win Rate</div>
                </div>
            </div>
        </div>
    )
